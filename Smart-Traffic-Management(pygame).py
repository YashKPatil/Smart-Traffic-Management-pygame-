...
class Main:
    ...
    background = pygame.image.load('D:\\python project\\car project\\Adaptive-Traffic-Signal-Timer-main\\Adaptive-Traffic-Signal-Timer-main\\Code\\YOLO\\darkflow\\images\\mod_int.png')
    ...
    redSignal = pygame.image.load('D:\\python project\\car project\\Adaptive-Traffic-Signal-Timer-main\\Adaptive-Traffic-Signal-Timer-main\\Code\\YOLO\\darkflow\\images\\signals\\red.png')
    yellowSignal = pygame.image.load('D:\\python project\\car project\\Adaptive-Traffic-Signal-Timer-main\\Adaptive-Traffic-Signal-Timer-main\\Code\\YOLO\\darkflow\\images\\signals\\yellow.png')
    greenSignal = pygame.image.load('D:\\python project\\car project\\Adaptive-Traffic-Signal-Timer-main\\Adaptive-Traffic-Signal-Timer-main\\Code\\YOLO\\darkflow\\images\\signals\\green.png')
